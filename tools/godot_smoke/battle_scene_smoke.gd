...
func _run() -> void:
	...
	_assert(String(intro_renderer.get("source_composite_mapping_status", "")) == "first_pass_generated_textbox_map_preview_rows", "expected renderer composite row mapping metadata")
