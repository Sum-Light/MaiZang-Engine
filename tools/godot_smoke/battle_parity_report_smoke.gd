...
func _init() -> void:
	...
	_assert(_array(sawyer.get("tests", [])).has("tools/godot_smoke/battle_asset_alpha_palette_smoke.gd"), "expected trainer asset alpha palette smoke reference")
	...
	_assert(_array(geodude.get("tests", [])).has("tools/godot_smoke/battle_asset_alpha_palette_smoke.gd"), "expected Pokemon asset alpha palette smoke reference")
	...
	_assert(_array(grass_environment.get("tests", [])).has("tools/godot_smoke/battle_asset_alpha_palette_smoke.gd"), "expected battle environment asset alpha palette smoke reference")
	...
	_assert(_array(big_pokeball_transition.get("tests", [])).has("tools/godot_smoke/battle_asset_alpha_palette_smoke.gd"), "expected battle transition asset alpha palette smoke reference")
