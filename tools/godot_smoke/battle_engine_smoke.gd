...
func _init() -> void:
	...
	_assert(_array_field(sawyer_lead, "moves").is_empty(), "expected Sawyer default moves to remain unresolved")
	_assert(_has_unsupported(sawyer_result, "missing_level_up_learnset_data"), "expected Sawyer missing learnset unsupported note")
