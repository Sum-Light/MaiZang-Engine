...
- [ ] B8.2 Implement source window layer renderer.
  ...
  - Remaining for this task: source-capture screenshot comparison against the new Godot-side action/message/move signatures, full link/recorded battle controller context beyond the text-printer slice, and broader `RenderText` control-code pixel side effects beyond the current first-pass clear/scroll slice.
  ...
  - Validate next: compare the Godot-side 240x160 action/message/move signatures against source captures and extend link/recorded coverage into battle controller/state context beyond the text-printer fixtures.
