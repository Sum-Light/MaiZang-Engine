...
- [ ] B8.2 Implement source window layer renderer.
  ...
  - Remaining for this task: full control-code pixel side effects, exact scroll/clear window pixel behavior, full link/recorded battle context, and screenshot comparison against source captures.
