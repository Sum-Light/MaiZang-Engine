...
- [ ] B8.2 Implement source window layer renderer.
  ...
  - Validate next: compare the Godot-side 240x160 action/message/move signatures against source captures, extend link/recorded coverage into full battle setup/controller flow beyond text-window propagation, and continue exact RenderText pixel equivalence for remaining control/font/string paths.
