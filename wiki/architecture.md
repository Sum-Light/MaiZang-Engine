...
- `ScriptVM` executes the first synchronous event-script subset for generated dialogue, movement-effect, and object-effect scripts and returns messages, movements, object effects, effects, unsupported ops, trace entries, and wait metadata.
