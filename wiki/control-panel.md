...
- Continue `wiki/battle-parity-execution-plan.md` B8.2: continue exact `RenderText` pixel equivalence beyond first-pass control-code side-effect coverage, extend link/recorded coverage beyond the first-pass Scene -> Renderer text-window context into full battle setup/controller flow, and compare action/message/move windows against source captures.
...
- Next executable battle task: continue B8.2 into source-capture screenshot comparison for the new Godot-side action/message/move signatures, full link/recorded battle setup/controller flow beyond text-window propagation, and exact `RenderText` pixel equivalence beyond the first-pass control-code side-effect fixtures.
