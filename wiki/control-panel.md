...
- Continue `wiki/battle-parity-execution-plan.md` B8.2: continue exact `RenderText` pixel equivalence beyond first-pass control-code side-effect coverage, extend link/recorded coverage beyond the first-pass text-printer context into full battle controller context, and compare action/message/move windows against source captures.
...
- Next executable battle task: continue B8.2 into source-capture screenshot comparison for the new Godot-side action/message/move signatures, full link/recorded battle controller context beyond text-printer metadata, and exact `RenderText` pixel equivalence beyond the first-pass control-code side-effect fixtures.
