...
- Next executable task: export source frame durations, frame counters, wrap behavior, DMA/copy target tile ranges, and affected metatile/tile ids.
...
- Continue `wiki/overworld-parity-todo.md` section 6: export source frame durations, frame counters, wrap behavior, DMA/copy target tile ranges, and affected metatile/tile ids.
...
- Current overworld Section 6 status: 7/14 complete; `tileset_header_report.json` now exports callback-to-map metadata for 785 layouts, 939 map source records, 137 layout tileset pairs, 136 referenced tilesets, and 31 callback symbols, plus 174 generated RGBA tileset-animation frame strips from 182 editable source PNG refs under `assets/generated/tileset_anims/`. `InitTilesetAnim_General` maps to 238 layouts/227 map records and `InitTilesetAnim_Petalburg` maps to 6/6, both including `MAP_LITTLEROOT_TOWN`; runtime tileset animation playback remains pending.
...
- Next executable overworld task: export source frame durations, frame counters, wrap behavior, DMA/copy target tile ranges, and affected metatile/tile ids.
