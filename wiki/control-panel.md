...
- Next executable task: support pausing/resetting animations across map transitions according to source callbacks.
...
- Continue `wiki/overworld-parity-todo.md` section 6: support pausing/resetting animations across map transitions according to source callbacks.
...
- Next executable battle task: continue B8.2 by supplying or recording `assets/source/battle_window_captures/action.png`, `message.png`, and `move.png` so the comparison gate moves from missing 3/3 to exact pixel comparison, or continue real link/recorded battle controller flow beyond setup metadata/text-window propagation and exact `RenderText` pixel equivalence beyond the first-pass control-code side-effect fixtures.
- Next executable overworld task: support pausing/resetting animations across map transitions according to source callbacks.
