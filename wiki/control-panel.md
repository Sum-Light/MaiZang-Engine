...
- Next executable task: design a Godot map-rendering owner to replace or wrap `DebugMapPlane` for source layer parity.
...
- Continue `wiki/overworld-parity-todo.md` section 5: design the layer-aware map-rendering owner that replaces or wraps `DebugMapPlane` for source layer parity.
...
- Next executable task: design the Godot map-rendering owner for source layer parity.
