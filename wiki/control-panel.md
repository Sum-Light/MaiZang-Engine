...
- Continue `wiki/overworld-parity-todo.md` section 6: add tests for animated water, flowers, currents, lava, falls, sand/water edges, and first-slice General/Petalburg animations.
...
- Next executable overworld task: add tests for animated water, flowers, currents, lava, falls, sand/water edges, and first-slice General/Petalburg animations.
