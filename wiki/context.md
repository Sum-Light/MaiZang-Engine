...
- `DataRegistry` now loads `data/generated/import_manifest.json` and can resolve generated map, tileset, map script, shared script, global text, Pokemon species JSON, Pokemon move JSON, and Pokemon ability JSON while preserving the first-slice start-map API.
