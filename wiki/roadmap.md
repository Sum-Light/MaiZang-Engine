...
- Implement simple single battle. First pass started with a UI-independent `BattleEngine` autoload, `create_single_battle_state`, and source-traced `create_wild_battle_state` for single wild encounters.
