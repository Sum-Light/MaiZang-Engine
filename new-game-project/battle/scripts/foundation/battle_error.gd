...
const TRACE_INVALID_CAPACITY: StringName = &"BATTLE_TRACE_INVALID_CAPACITY"
const TRACE_INVALID_TEST_SCOPE: StringName = &"BATTLE_TRACE_INVALID_TEST_SCOPE"
const TRACE_SCOPE_ALREADY_ACTIVE: StringName = &"BATTLE_TRACE_SCOPE_ALREADY_ACTIVE"
const TRACE_SCOPE_REQUIRED: StringName = &"BATTLE_TRACE_SCOPE_REQUIRED"
const TRACE_SCOPE_MISMATCH: StringName = &"BATTLE_TRACE_SCOPE_MISMATCH"
const TRACE_INVALID_RECORD_ID: StringName = &"BATTLE_TRACE_INVALID_RECORD_ID"
const TRACE_INVALID_RNG_CURSOR: StringName = &"BATTLE_TRACE_INVALID_RNG_CURSOR"
const TRACE_CAPACITY_EXCEEDED: StringName = &"BATTLE_TRACE_CAPACITY_EXCEEDED"
